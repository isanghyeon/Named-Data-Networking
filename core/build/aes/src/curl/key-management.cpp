...
void KeyManagement::pubKeyExchange() {
    ...
    this->list = curl_slist_append(this->list, "Accept: application/json");
    this->list = curl_slist_append(this->list, header_author);
    this->list = curl_slist_append(this->list, "Authorization: ");
